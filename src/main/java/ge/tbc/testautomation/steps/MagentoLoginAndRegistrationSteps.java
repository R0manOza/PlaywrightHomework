...
public class MagentoLoginAndRegistrationSteps {
    ...
    @Step("Attempt to add a product to the wishlist while unauthorized")
    ...
    @Step("Verify that the page has redirected to the Customer Login page")
    ...
    @Step("Create a new random account and verify successful login")
    public String[] createNewAccountAndVerifyLogin() {// this should have been done wayyy better . ive read the feedback and will decondsturct all steps that are way too big
    ...
    @Step("Verify that product '{productName}' was added to the wishlist")
    ...
    @Step("Register a new user: {firstName} {lastName} ({email})")
